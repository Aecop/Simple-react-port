...
const Features = () => {
    return (
        <section id='features' className="w-full h-[800px] pb-10 border-b-[1px]">
            ...
            <div className="grid grid-cols-2 gap-20">
                <Card
                title="IT Ops"
                description="Maintains the computer networks of all types of organisations, providing technical support and ensuring the whole company runs smoothly.  "
                icon={<RiComputerFill/>}/>
                <Card
